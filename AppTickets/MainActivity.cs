...
namespace AppTickets
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            btnProgramador = FindViewById<Button>(Resource.Id.btnProgramador);
        ...
        {
            var layout_registrar = new Intent(this, typeof(RegistrarUsuario));
            StartActivity(layout_registrar);
            Finish();
        }
        ...
        private void BtnProgramador_Click(object sender, System.EventArgs e)
        {
